...
// using Flex.Quality.Templates.Aggregates;
// using Volo.Abp.Domain.Repositories.EntityFrameworkCore;
//
// namespace Flex.Quality.EntityFrameworkCore.Templates;
//
// /// <summary>
// /// 模板 仓储Ef core 实现
// /// </summary>
// public class EfCoreTemplateRepository :
//     EfCoreRepository<IQualityDbContext, Template, Guid>,
//     ITemplateRepository
// {
//     public EfCoreTemplateRepository(IDbContextProvider<IQualityDbContext> dbContextProvider) : base(dbContextProvider)
//     {
//     }
//
