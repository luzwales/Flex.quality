...
// using Flex.Quality.EntityModels.Dto;
// using Flex.Quality.EnumTypes;
// using Flex.Quality.Projects.Dto;
// using Flex.Quality.Projects.Dto.Generators;
//
// namespace Flex.Quality.Projects;
//
// public class ProjectEntityManager : QualityDomainService
// {
