...
public class QualityDbMigrationService : ITransientDependency
{
    private readonly ICurrentTenant _currentTenant;

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IQualityDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;

    public QualityDbMigrationService(
        IDataSeeder dataSeeder,
        IEnumerable<IQualityDbSchemaMigrator> dbSchemaMigrators,
        ...
        ICurrentTenant currentTenant)
    {
        ...
        Logger = NullLogger<QualityDbMigrationService>.Instance;
    }

    public ILogger<QualityDbMigrationService> Logger { get; set; }
