...
from
'./Create{{ context.EntityModel.AggregateCode }}.vue';
import Update{
...
from
'./Update{{ context.EntityModel.AggregateCode }}.vue';
...
setup()
{
    ...
    const [registerCreate{{context.EntityModel.AggregateCode}}Modal, {openModal: openCreate{{
        context
        .
        EntityModel
        .
    ...
    const [registerUpdate{{context.EntityModel.AggregateCode}}Modal, {openModal: openUpdate{{
        context
        .
        EntityModel
        .
