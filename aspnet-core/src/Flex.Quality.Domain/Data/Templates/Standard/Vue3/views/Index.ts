...
{
    {
        context.EntityModel.AggregateCodePluralized
    }
}
ServiceProxy,
    Delete
{
    {
        context.EntityModel.AggregateCode
    }
}
Input,
    Page
 ...
 */
export async function pageAsync(params: Page {
    {
        context.EntityModel.AggregateCode
    }
}
...
)
{
    const {
    {
        context.EntityModel.AggregateCodeCamelCase
    }
}
    ServiceProxy = new {
    {
